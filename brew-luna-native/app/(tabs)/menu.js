...
import { Search, ShoppingCart, Plus, Coffee } from 'lucide-react-native';
        ...
        <Animated.FlatList
          ...
          ListEmptyComponent={() => (
            <View style={styles.emptyContainer}>
              <Coffee size={48} color={P_COLORS.subtext} strokeWidth={1.5} style={{ marginBottom: 12, opacity: 0.6 }} />
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 32, fontFamily: 'PlayfairDisplay_700Bold', color: P_COLORS.text, letterSpacing: -0.5 },
  ...
  searchInput: { flex: 1, height: '100%', fontSize: 16, color: P_COLORS.text, fontFamily: 'Poppins_400Regular' },
  ...
  categoryText: { color: P_COLORS.subtext, fontFamily: 'Poppins_600SemiBold', fontSize: 14 },
  ...
  gridTitle: { fontSize: 16, fontFamily: 'Poppins_600SemiBold', color: P_COLORS.text, marginBottom: 4 },
  gridSub: { fontSize: 12, fontFamily: 'Poppins_400Regular', color: P_COLORS.subtext, marginBottom: 12 },
  gridFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  gridPrice: { fontSize: 16, fontFamily: 'Poppins_600SemiBold', color: P_COLORS.text },
  ...
  loadingText: { marginTop: 16, color: P_COLORS.subtext, fontSize: 15, fontFamily: 'Poppins_400Regular' },
  emptyContainer: { marginTop: 60, alignItems: 'center', paddingHorizontal: 32 },
  emptyText: { color: P_COLORS.subtext, fontSize: 15, fontFamily: 'Poppins_400Regular', textAlign: 'center' }
});
