...
import { ChevronLeft, Heart, Check, ShoppingBag, AlertCircle } from 'lucide-react-native';
...
export default function ProductDetailScreen() {
  ...
  const isColdStr = product.category_id === 4 ? 'Froid 🧊' : 'Chaud ☕';
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.tagsRow}>
          <View style={styles.tagPill}><Text style={styles.tagText}>{isColdStr}</Text></View>
          <View style={styles.tagPill}><Text style={styles.tagText}>{volumeStr}</Text></View>
          <View style={styles.tagPill}><Text style={styles.tagText}>Caffeine: Moyenne</Text></View>
        </View>
...
const styles = StyleSheet.create({
  ...
  tagPill: { backgroundColor: C.primary, borderWidth: 1, borderColor: C.secondaryText, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12 },
  tagText: { fontFamily: FONT.poppins, fontSize: 10, color: C.rosewood },
