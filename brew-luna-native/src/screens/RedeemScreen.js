...
import { Coffee, Percent, Cookie, Milk, Gift, Sparkles } from 'lucide-react-native';
...
const RewardCard = ({ reward, canAfford, onRedeem }) => {
  const LucideIcon = REWARD_LUCIDE[reward.id] || Gift;
  return (
  <View style={s.rewardCard}>
    <View style={s.rewardIconWrap}>
      <LucideIcon size={26} color={C.primary} strokeWidth={2} />
    </View>
