...
export const TIERS = [
  {
    ...
    textColor: '#3D1C0C',
    icon: 'coffee-outline',
    description: 'Bienvenue dans la famille Coffee Time',
  },
  {
    name: 'Silver',
    minPoints: 500,
    ...
    description: 'Un habitué apprécié de Coffee Time',
  },
  {
    name: 'Gold',
    minPoints: 1500,
    ...
    textColor: '#2C1810',
    icon: 'star-outline',
    description: 'Un membre VIP de Coffee Time',
  },
  {
    name: 'Platinum',
    minPoints: 4000,
    ...
    description: 'Le sommet de la fidélité Coffee Time',
  },
];
